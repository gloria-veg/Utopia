...
public class UserService {
    ...
    public void createUser(User user)
        ...
        Optional<User> userEmailAddressOptional = userRepo
                .findByEmailAddress(user.getEmailAddress());
        ...
        if (userEmailAddressOptional.isPresent()) {
            System.out.println(userEmailAddressOptional.get());
            throw new IllegalArgumentException("User Address exists");
        } else {
            userRepo.save(user);
        }
